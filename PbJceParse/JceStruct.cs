...
namespace TCSniffer.PbJceParse
{
                        ...
                        case (int)JceType.TYPE_SHORT:
                            {
                                ...
                                subNode = "[" + tag.ToString() + "](Short):" +
                                    BitConverter.ToInt16(jceData.Reverse().ToArray(), 0).ToString();
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_INT:
                            {
                                ...
                                //ubNode = "Field #" + tag.ToString() + " [" + Hex + "] (Int) Value=" + BitConverter.ToInt32(jceData.Reverse().ToArray(), 0).ToString() + " Hex=" + BitConverter.ToString(jceData).Replace("-", " ");
                                subNode = "[" + tag.ToString() + "](Int):" +
                                     BitConverter.ToInt32(jceData.Reverse().ToArray(), 0).ToString();
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_LONG:
                            {
                                ...
                                subNode = "[" + tag.ToString() + "](Long):" + BitConverter.ToInt64(jceData.Reverse().ToArray(), 0).ToString();
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_FLOAT:
                            {
                                ...
                                subNode = "[" + tag.ToString() + "](Single):" + BitConverter.ToSingle(jceData.Reverse().ToArray(), 0).ToString();
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_DOUBLE:
                            {
                                ...
                                subNode = "[" + tag.ToString() + "](Double):" + BitConverter.ToDouble(jceData.Reverse().ToArray(), 0).ToString();
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_STRING1:
                            {
                                ...
                                if (jceDatalen > 0)
                                {
                                    ...
                                    subNode = "[" + tag.ToString() + "](String):" + str;
                                }
                                else
                                {
                                    //subNode = "Field #" + tag.ToString() + " [" + Hex + "] (LongString) Length=0 Hex=00";
                                    subNode = "[" + tag.ToString() + "](String):" ;
                                }
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_STRING4:
                            {
                                ...
                                if (jceDatalen > 0)
                                {
                                    ...
                                    subNode = "[" + tag.ToString() + "](LongString):" + str;
                                }
                                else
                                {
                                    subNode = "Field #" + tag.ToString() + " [" + Hex + "] (LongString) Length=0 Hex=00";
                                    subNode = "[" + tag.ToString() + "](LongString):";
                                }
                                NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                break;
                            }
                        case (int)JceType.TYPE_MAP:
                            {
                                ...
                                subNode = "[" + tag.ToString() + "](Map," + count.ToString() + ")";
                                if (count > 0)
                                {
                                    MapCount.Add(count);
                                    MapKey = false;
                        ...
                        case (int)JceType.TYPE_LIST:
                            {
                                ...
                                subNode = "[" + tag.ToString() + "](List," + count.ToString() + ")";
                                if (count > 0)
                                {
                                    ListCount.Add(count);
                                    var RandKey = new Random().Next().ToString();
                        ...
                        case (int)JceType.TYPE_STRUCT_BEGIN:
                            {
                                ...
                                {
                                    //subNode = "Field #" + tag.ToString() + " [STRUCT_BEGIN]";
                                    NodeStruct.CurrentNode.Nodes.Add("[" + tag.ToString() + "]┛");
                                }
                                else
                                {

                                    NodeStruct.CurrentNode.Nodes.Add("┛");
                                }
                        ...
                        case (int)JceType.TYPE_SIMPLE_LIST:
                            {
                                ...
                                if (jceDatalen > 0)
                                {
                                    ...
                                    subNode = "[" + tag.ToString() + "](SimpleList="+ jceDatalen.ToString();
                                    jceData = NodeStruct.BytesIn.Take(jceDatalen).ToArray();
                                    ...
                                    else
                                    {
                                        ...
                                        subNode = "[" + tag.ToString() + "](SimpleList=" + jceData.Length.ToString();
                                        NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                    }
                                }
                                else
                                {
                                    ...
                                    subNode = "[" + tag.ToString() + "](SimpleList=0";
                                    NodeStruct.CurrentNode.Nodes.Add(new TreeNode(subNode));
                                }
                                MapKey = true;
                                break;
